//The advantage of Merge Sort for linked lists is that it doesn’t require random access to
// elements, which is not efficient for linked lists since we need to traverse the list linearly.
